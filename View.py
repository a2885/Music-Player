...
class View:
    ...
    def setup_player(self):
        ...
        self.playList.configure(font="Italic")
    ...
    def add_song_to_favourites(self):
        ...
        try:
            if len(fav_song_index_tuple) == 0:
                raise NoSongSelectedError("please select a song before to favourites")
    ...
    def remove_song_from_favourites(self):
        ...
        try:
            ...
            result = self.my_player.remove_song_from_favourties(remove_song)
            ...
            messagebox.showerror("DB Error!","Song can not be remove ")
            print(traceback.format_exc())
    ...
    def load_songs_from_favourites(self):
        try:
            ...
            mycolor = "#" + red + green + blue
            self.playList.config(fg=mycolor)
            messagebox.showinfo("Favourites loaded!!!", "No song present in your favourites")
